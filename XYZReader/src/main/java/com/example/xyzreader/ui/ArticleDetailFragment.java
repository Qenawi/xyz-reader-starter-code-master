...
public class ArticleDetailFragment extends Fragment implements
            ...
            Bundle savedInstanceState)
    {
        ...
        //-------------
        collapsingToolbar = (CollapsingToolbarLayout) mRootView.findViewById(R.id.CP);
        collapsingToolbar.setExpandedTitleColor(ContextCompat.getColor(getActivity(), android.R.color.transparent));
        collapsingToolbar.setCollapsedTitleTextColor(ContextCompat.getColor(getActivity(), android.R.color.white));
